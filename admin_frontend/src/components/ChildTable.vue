    ...
    <div class="overflow-x-auto">
      <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tr v-for="(row, idx) in paginatedRows" :key="idx" class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
            ...
            >
              <template v-if="config.fields[fieldName]">
                ...
                <textarea
                  ...
                  :value="row[fieldName]"
                  :disabled="isReadonly(fieldName)"
                  @input="updateField(idx, fieldName, ($event.target as HTMLTextAreaElement).value)"
                  rows="1"
                  class="block w-full px-2 py-1.5 text-sm border-gray-300 dark:border-gray-600 rounded-md focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white min-w-[200px]"
                ></textarea>
