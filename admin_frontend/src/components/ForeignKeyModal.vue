...
async function loadModel() {
  ...
  try {
    const config = await adminStore.getForeignKeyModel(appLabel, modelName)
...
<template>
  <Teleport to="body">
    <div
      role="dialog" aria-modal="true" class="fixed inset-0 z-[99999] flex items-start justify-center bg-black/50 p-4 pt-16 overflow-y-auto"
