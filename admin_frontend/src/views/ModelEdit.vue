...
const isDirty = computed(() => {
  ...
  return Object.keys(getChangedFields(formData.value, originalData.value)).length > 0
})
...
<template>
  <div ref="formTopRef">
    ...
    <Teleport to="body">
      <div v-if="showDeleteConfirm" role="dialog" aria-modal="true" class="fixed inset-0 z-50 flex items-center justify-center">
