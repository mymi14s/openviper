...
.. code-block:: bash
   ...
   # Set a real secret key and change the database URL in myblog/settings.py
   SECRET_KEY = "change-this-in-production"
   # In DATABASES["default"]["OPTIONS"]["URL"]:
   #   "sqlite+aiosqlite:///blog.sqlite3"                     # for SQLite
   #   "postgresql+asyncpg://user:password@localhost:5432/dbname"  # for Postgres
   #   "mysql+aiomysql://user:password@localhost/dbname"           # for Mariadb
...
.. code-block:: bash
   ...
   python viperctl.py migrate # apply schema changes
...
.. code-block:: bash
   ...
   python viperctl.py start-server --reload # optional --host [IP_ADDRESS] --port 8000 --reload
