...
type ModerationPayload = dict[str, str | float | bool]
...
class ModerationResult:
    ...
    def to_dict(self) -> ModerationPayload:
        return {
...
moderators: dict[str, AIContentModerator] = {}
...
def get_moderator(model_name: str = "granite-code:3b") -> AIContentModerator:
    ...
    if model_name not in moderators:
        moderators[model_name] = AIContentModerator(model_name=model_name)
    return moderators[model_name]
