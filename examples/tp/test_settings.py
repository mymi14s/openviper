...
openviper_url = settings.DATABASES["default"]["OPTIONS"]["URL"]
project_url = ProjectSettings.DATABASES["default"]["OPTIONS"]["URL"]

print(f"openviper settings DATABASES URL: {openviper_url}")
print(f"ProjectSettings DATABASES URL: {project_url}")
