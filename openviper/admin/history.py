...
class ChangeHistory(Model):
    ...
    def get_changed_fields_dict(self) -> dict[str, t.Any]:
...
def normalize_for_compare(val: t.Any) -> t.Any:
...
def compute_changes(
    old_data: dict[str, t.Any], new_data: dict[str, t.Any]
    ...
    for key in new_data:
        ...
        if normalize_for_compare(old_val) != normalize_for_compare(new_val):
