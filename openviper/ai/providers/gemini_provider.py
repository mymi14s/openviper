...
class GeminiProvider(AIProvider):
    ...
    def __init__(self, config: dict[str, object]) -> None:
        ...
        self._timeout: float = float(self.config.get("timeout", 120.0))
    ...
    def get_client(self) -> object:
        ...
        if self._client is None:
            ...
            if hasattr(self._types, "HttpOptions"):
                kwargs["http_options"] = self._types.HttpOptions(timeout=self._timeout * 1000)
