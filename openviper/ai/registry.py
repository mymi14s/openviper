...
class ProviderRegistry:
    ...
    def register_provider(self, provider: AIProvider, *, allow_override: bool = True) -> None:
        ...
        """
        from openviper.exceptions import ModelCollisionError
    ...
    def discover_entrypoints(
        ...
        *,
        ...
        try:
            ...
            logger.warning(
                "ProviderRegistry.discover_entrypoints: importlib.metadata unavailable "
                "(Python < 3.9?)."
            )
            return 0
    ...
    def get_by_model(self, model_id: str) -> AIProvider:
        ...
        if provider is None:
            from openviper.exceptions import ModelNotFoundError
