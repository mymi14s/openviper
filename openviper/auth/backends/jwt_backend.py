...
class JWTBackend:
    ...
    Accepts both a :class:`~openviper.http.request.Request` object (the
    normal path) and a raw scope dict for direct calls.
    """
    ...
    async def authenticate(
        ...
        try:
            ...
            logger.debug("JWT backend authentication failed: %s", exc)
