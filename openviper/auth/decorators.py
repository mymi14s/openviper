...
def permission_required(codename: str) -> Callable[..., object]:
...
def role_required(role_name: str) -> Callable[..., object]:
...
def superuser_required(func: Callable[..., object]) -> Callable[..., object]:
...
def staff_required(func: Callable[..., object]) -> Callable[..., object]:
