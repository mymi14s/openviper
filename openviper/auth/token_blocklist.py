...
from openviper.auth.constants import BLOCKLIST_CACHE_MAXSIZE, BLOCKLIST_NEGATIVE_CACHE_TTL
...
def evict_blocklist_cache_if_full(cache: dict[str, float], now: float) -> None:
    ...
    """
    evict_cache_if_full(cache, BLOCKLIST_CACHE_MAXSIZE, now, lambda v: v)
...
async def is_token_revoked(jti: str) -> bool:
    ...
    async with lock:
        ...
        JTI_VALID_CACHE[jti] = now + BLOCKLIST_NEGATIVE_CACHE_TTL
