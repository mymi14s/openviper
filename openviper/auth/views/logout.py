...
class LogoutView(View):
    ...
    async def post(self, request: Request, **kwargs: object) -> dict[str, str] | JSONResponse:
        ...
        if auth_type == "jwt":
            ...
            await SessionManager().logout(request, response)
        else:
        ...
        return response if response is not None else {"detail": "Logged out."}
