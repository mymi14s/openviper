...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            ...
            default=None,
            help=(
                "NOT RECOMMENDED for production use - password will be visible in the process list"
            ),
        )
    ...
    def handle(self, **options) -> None:  # type: ignore[override]
        ...
        if options.get("password"):
            self.stderr(
                self.style_warning(
                    ...
                    "Use interactive mode or environment variables in production."
                )
            )
        ...
        async def create() -> None:
            ...
            user = User(**build_user_kwargs(field_names, username, email))
