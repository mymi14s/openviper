...
from openviper.db.constants import DEFAULT_ALIAS
...
class ConnectionManager:
    ...
    Loads ``DATABASES`` configuration and instantiates one
    ``DatabaseBackend`` per alias.
    """
    ...
    def normalize_database_url(self) -> None:
        """Fallback: normalize a flat DATABASE_URL into a single default alias config."""
