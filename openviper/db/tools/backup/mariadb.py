...
def build_mysql_args(database_url: str) -> tuple[list[str], str, str]:
...
def mysql_defaults_file(password: str) -> Generator[list[str]]:
    ...
    if "\x00" in password or "\n" in password or "\r" in password:
        raise ValidationError("MySQL password contains unsafe option-file control characters.")
