...
async def run_subprocess(
    ...
    *,
    ...
    Args:
        ...
        stdin_data: Optional string to pipe to the child's stdin.
            When provided, the subprocess receives input on stdin rather
            than via command-line arguments, preventing injection attacks.
