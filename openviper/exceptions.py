...
class HTTPException(OpenViperException):
    ...
    Args:
        ...
        detail: Error detail string or structured payload.
...
class ValidationError(HTTPException):
    ...
    def __init__(self, errors: list[dict[str, str | int]] | dict[str, str | int]) -> None:
...
class ModelCollisionError(AIException):
    ...
    def __init__(self, model: str, existing_provider: str, new_provider: str) -> None:
        super().__init__(
            ...
            "Set allow_override=True to replace the existing registration."
        )
        self.model = model
