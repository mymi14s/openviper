...
def actor(
    ...
    **options: t.Any,
    ...
    All dramatiq actor options are forwarded to the underlying
    dramatiq actor, including retry, backoff, time limit, result
    storage, and priority configuration.
    """
    ...
    def decorator(func: t.Callable[..., t.Any]) -> t.Callable[..., t.Any]:
        ...
        if store_results:
            actor_options["store_results"] = True
        actor_options.update(options)

        registry.register_actor(
            name, func, queue_name=queue_name, options=actor_options,
        )
    ...
    *,
    ...
    try:
        ...
        try:
            ...
            try:
                fn = registry.get_actor(actor_name)
                actor_options = registry.get_actor_options(actor_name)
