...
# Dedicated thread pool for async operations - sized for typical ASGI concurrency
...
def setup_cleanup_task() -> None:
    ...
    TASKS["cleanup_enabled"] is set to 1 or True.
    ...
    try:
        ...
        task_cfg: dict[str, Any] = getattr(settings, "TASKS", {}) or {}
        cleanup_days = int(task_cfg.get("cleanup_days", 7))
