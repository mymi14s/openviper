...
active_language: ContextVar[str] = ContextVar("active_language", default="en")
translations_cache: dict[str, gettext_module.NullTranslations] = {}
...
def get_translation_object(language: str) -> gettext_module.NullTranslations:
...
def gettext(message: str) -> str:
    ...
    lang = get_language()
    translation = get_translation_object(lang)
...
gettext_lazy_alias = gettext_lazy
