...
class TestFullSystemIntegration:
    ...
    async def test_authentication_and_session_flow(
        ...
        assert await check_password(ADMIN_PASSWORD, admin_user.password)
    ...
    async def test_database_operations_with_relationships(
        self,
        test_database,
        sample_test_data: dict[str, object],
    ):
    ...
    async def test_complete_application_workflow(
        ...
        await admin.set_password(ADMIN_PASSWORD)
        await admin.save()
        ...
        await editor.set_password(EDITOR_PASSWORD)
        await editor.save()
