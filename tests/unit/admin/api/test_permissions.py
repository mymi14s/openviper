...
def make_user(is_authenticated=True, is_staff=False, is_superuser=False, has_perm=True):
    """Create a mock user."""
    user = MagicMock()
...
def make_model_class(name="TestModel"):
...
class TestCheckAdminAccess:
    ...
    def test_staff_user_has_access(self):
        ...
        user = make_user(is_authenticated=True, is_staff=True)
    ...
    def test_superuser_has_access(self):
        ...
        user = make_user(is_authenticated=True, is_superuser=True)
        request = make_request(user)
    ...
    def test_staff_and_superuser_has_access(self):
        ...
        user = make_user(is_authenticated=True, is_staff=True, is_superuser=True)
        request = make_request(user)
    ...
    def test_regular_authenticated_user_no_access(self):
        ...
        user = make_user(is_authenticated=True, is_staff=False, is_superuser=False)
        request = make_request(user)
...
class TestCheckObjectPermission:
    ...
    def test_superuser_has_all_object_permissions(self):
        ...
        request = make_request(user)
        obj = MagicMock()
        obj.__class__ = make_model_class()
...
class TestPermissionChecker:
    ...
    def test_has_admin_access_property_regular_user(self):
        ...
        user = make_user(is_authenticated=True, is_staff=False)
        request = make_request(user)
        checker = PermissionChecker(request)
...
class TestPermissionCheckerWithDifferentUsers:
    ...
    def test_superuser_permissions(self):
        ...
        user = make_user(is_authenticated=True, is_superuser=True, is_staff=False)
        request = make_request(user)
        checker = PermissionChecker(request)
        model_class = make_model_class()
    ...
    def test_staff_permissions(self):
        ...
        user = make_user(is_authenticated=True, is_staff=True, is_superuser=False)
        request = make_request(user)
        checker = PermissionChecker(request)
        model_class = make_model_class()
    ...
    def test_regular_user_no_permissions(self):
        ...
        user = make_user(is_authenticated=True, is_staff=False, is_superuser=False, has_perm=False)
        request = make_request(user)
        checker = PermissionChecker(request)
        model_class = make_model_class()
