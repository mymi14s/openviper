...
def make_model_class(name="TestModel", fields=None):
...
def make_model_admin(model_class, list_display=None):
...
def make_model_instance(model_class, **kwargs):
...
class TestSerializeInstance:
    ...
    def test_basic_serialization(self):
        ...
        model_class = make_model_class(fields=fields)
        model_admin = make_model_admin(model_class)
...
class TestSerializeForList:
    ...
    def test_serializes_list_display_fields(self):
        ...
        model_class = make_model_class()
        model_admin = make_model_admin(model_class, list_display=["id", "name"])
    ...
    def test_handles_missing_attributes(self):
        ...
        model_class = make_model_class()
        model_admin = make_model_admin(model_class, list_display=["id", "missing"])
...
class TestSerializeModelInfo:
    ...
    def test_returns_model_info(self):
        ...
        model_class = make_model_class("User")
        model_admin = make_model_admin(model_class)
...
class TestModelListSerializer:
    ...
    def test_serialize_multiple_instances(self):
        ...
        model_class = make_model_class()
        model_admin = make_model_admin(model_class, list_display=["id"])
        serializer = ModelListSerializer(model_admin)
