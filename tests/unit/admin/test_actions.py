...
def make_user(is_authenticated=True, is_superuser=False, is_staff=False):
    """Create a mock user."""
    user = MagicMock()
...
class TestRegisterAction:
    ...
    def test_register_action_class(self):
        ...
        assert "my_action" in action_registry
        assert action_registry["my_action"] is MyAction
    ...
    def test_register_action_decorator(self):
        ...
        assert "decorated" in action_registry
        assert action_registry["decorated"] is DecoratedAction
...
class TestGetAvailableActions:
    ...
    def test_get_available_actions_filters_by_permission(self):
        ...
        action_registry["protected"] = ProtectedAction
...
class TestActionDecorator:
    ...
    def test_decorator_with_parentheses(self):
        ...
        action_class = action_registry["test_action"]
    ...
    def test_decorator_without_parentheses(self):
        ...
        assert "simple_action" in action_registry
    ...
    async def test_decorated_sync_function(self):
        ...
        action_class = action_registry["sync_action"]
        action_instance = action_class()
    ...
    async def test_decorated_function_with_three_params(self):
        ...
        action_class = action_registry["admin_action"]
        action_instance = action_class()
    ...
    def test_decorator_with_permissions(self):
        ...
        action_class = action_registry["protected_action"]
        action_instance = action_class()
