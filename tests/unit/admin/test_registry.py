...
class TestAdminRegistry:
    ...
    def test_get_all_models(self):
        ...
        registry = AdminRegistry()
        model1 = make_model_class("Model1")
        model2 = make_model_class("Model2")
    ...
    def test_get_models_grouped_by_app(self):
        ...
        registry = AdminRegistry()
        model1 = make_model_class("User", "auth")
        model2 = make_model_class("Post", "blog")
        model3 = make_model_class("Comment", "blog")
    ...
    def test_get_model_by_app_and_name(self):
        ...
        registry = AdminRegistry()
        model = make_model_class("Post", "blog")
...
class TestRegistryEdgeCases:
    ...
    def test_multiple_registrations_same_name_different_apps(self):
        ...
        registry = AdminRegistry()
        model1 = make_model_class("User", "app1")
        model2 = make_model_class("User", "app2")
