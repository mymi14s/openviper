...
from openviper.core.email.message import EmailMessageData, build_message, split_mimetype
...
def test_split_mimetype_falls_back_when_missing_subtype() -> None:
    assert split_mimetype("text/plain") == ("text", "plain")
    assert split_mimetype("invalid") == ("application", "octet-stream")
