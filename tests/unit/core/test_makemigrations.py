...
class TestAutoMigrationName:
    ...
    def test_rename_column(self):
        ...
        assert auto_migration_name(ops) == "rename_fullname_to_name"

    def test_restore_column(self):
        """Test RestoreColumn operation naming."""
        ops = [RestoreColumn("users", "avatar")]
        assert auto_migration_name(ops) == "restore_avatar"
    ...
    def test_multiple_operations(self):
        ...
        assert auto_migration_name(ops) == "add_bio_remove_avatar"

    def test_empty_operations(self):
        """Test empty operations return 'auto'."""
        assert auto_migration_name([]) == "auto"
