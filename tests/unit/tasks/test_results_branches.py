...
class TestGetEngineDoubleCheckLocking:
    """Test double-check locking pattern in get_engine."""
    ...
    def test_second_thread_finds_engine_already_created(self):
        ...
        def mockcreate_engine_once(*args, **kwargs):
            nonlocal call_count
            call_count += 1
            if call_count == 1:
        ...
        with patch("openviper.tasks.results.resolve_db_url", return_value="sqlite:///test.db"):
            with patch("openviper.tasks.results.create_engine") as mock_create:
                mock_create.side_effect = mockcreate_engine_once
...
class TestResolveDbUrlExceptionHandling:
    """Test exception handling in resolve_db_url."""
...
class TestBuildUpsertFnEmptyUpdateBranches:
    ...
    def test_sqlite_with_empty_update_data(self):
        ...
        upsert_fn = build_upsert_fn("sqlite")
    ...
    def test_mysql_with_empty_update_data(self):
        ...
        upsert_fn = build_upsert_fn("mysql")
    ...
    def test_mariadb_with_empty_update_data(self):
        ...
        upsert_fn = build_upsert_fn("mariadb")
    ...
    def test_generic_with_update_data_updates_existing_row(self):
        ...
        upsert_fn = build_upsert_fn("unknown_dialect")
...
class TestUpsertResultJsonSerializationError:
    ...
    def test_falls_back_to_repr_on_json_error(self):
        ...
        with patch("openviper.tasks.results.get_engine", return_value=mock_engine):
...
class TestBatchUpsertResultsExceptionHandling:
    ...
    def test_handles_engine_error(self):
        ...
        with patch("openviper.tasks.results.get_engine") as mockget_engine:
            mockget_engine.side_effect = RuntimeError("No DB")
