...
class TestRunWorker:
    ...
    def test_does_nothing_when_disabled(self, mock_logging, mock_settings):
        """Should exit early when TASKS dict is empty."""
        mock_settings.TASKS = {}
    ...
    def test_starts_worker_when_enabled(
        ...
        """Should start worker when TASKS is configured."""
        mock_settings.TASKS = {"broker": "stub", "scheduler": False}
    ...
    def test_starts_scheduler_when_enabled(
        ...
        """Should start scheduler when scheduler=True."""
        mock_settings.TASKS = {"broker": "stub", "scheduler": True}
